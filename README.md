...
```javascript
iterSqrt1pm1 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-sqrt1pm1@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-sqrt1pm1@v0.2.3-umd/browser.js"></script>
```
